...
extension_checker_logger = logging.getLogger("extension_checker_logger")
extension_checker_logger.setLevel(logging.INFO)
extension_checker_handler = logging.FileHandler("file_extension_log.txt", encoding="utf-8")
...
loading_checker_logger = logging.getLogger("loading_checker_logger")
loading_checker_logger.setLevel(logging.ERROR)
loading_checker_handler = logging.FileHandler("file_load_log.txt", encoding="utf-8")
loading_checker_formatter = logging.Formatter("%(asctime)s : %(message)s")
loading_checker_handler.setFormatter(loading_checker_formatter)
loading_checker_logger.addHandler(loading_checker_handler)
...
def page_post_upload():
    ...
    if picture:
        ...
        loading_checker_logger.error(f"Файл не загружен")
        return f"<pre><link rel='stylesheet' href='/static/style.css'>" \
